...
router.get(
  "/withgroup/:groupid",
  require("../controllers/messages/getmessages-withgroup"),
);
router.get(
  "/withuser/:userid",
  require("../controllers/messages/getmessages-withuser"),
);
router.get(
  "/withuser/:user1/:user2",
  require("../controllers/messages/getmessages-between"),
);
router.get("/message/:id", require("../controllers/messages/getmessage"));
router.get(
  "/messagebydate/:date",
  require("../controllers/messages/getmessage-bydate"),
);
